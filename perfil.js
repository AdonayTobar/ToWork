...
let correoPersona = JSON.parse(localStorage.getItem('correoPersona'));
...
const usuario = document.querySelector(".publi h2");
...
const amigoIndex = usuarioActual.amigos.findIndex(amigo => amigo.correo === correoPersona);
const editarPerfil = document.querySelector(".editar");
const diferente = document.querySelector(".perfil")
...
function cambiarIcono(){
  if (amigoIndex >= 0) {
  // El usuario es amigo, cambia la imagen
  seguir.src = "./icon/free_icon_1 (24).svg";
} else {
  seguir.src = "./icon/free_icon_1 (23).svg";
}
}
...
seguir.addEventListener("click", () => {
  ...
  if (amigoIndex >= 0) {
    usuarioActual.amigos.splice(amigoIndex, 1);
    seguir.src = "./icon/free_icon_1 (24).svg";
    location.reload();
  } else {
    usuarioActual.amigos.push(siguiendo);
    seguir.src = "./icon/free_icon_1 (23).svg";
    location.reload();
  }
...
function obtenerDatosActualizados() {
 ...
 publicaciones = JSON.parse(localStorage.getItem('publicaciones'));
  ...
  //Funcion para mostrar las publicacaiones
  ...
  function mostrarPublicaciones(){
    ...
    const publicacionesFiltradas = publicaciones.filter(publicacion => {
      return publicacion.correo === correoPersona;
    });
    
        main.innerHTML = "";
        const newArray = [...publicacionesFiltradas].reverse();
